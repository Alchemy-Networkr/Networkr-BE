...
module.exports = 
  Router()
    ...
    .get('/All-Curriculum-Projects/:id', authMiddleware, async(req, res) => {
      const detailedCurriculum = await CurriculumProject.findById(req.params.id);
      console.log(detailedCurriculum);
      res.render('Detailed-Curriculum', {
        detailedCurriculum
      });
    })
